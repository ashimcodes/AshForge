<div align="center">
  ...
  <img src="assets/readme/logo.svg" alt="Ash Forge Logo" width="104" height="104" style="border-radius: 24px;" />
  ...
  **Chat with coding agents, edit projects, execute real Linux commands, and preview live web servers — all directly on your phone.**
  ...
  [![Release v1.0.3](https://img.shields.io/badge/Release-v1.0.3-F28C52?style=flat-square&logo=github&logoColor=white)](https://github.com/ashimcodes/AshForge/releases/tag/v1.0.3)
  ...
  [![Watch demo](https://img.shields.io/badge/Watch-Demo-FF0000?style=flat-square&logo=youtube&logoColor=white)](https://www.youtube.com/ashim)

  <br />

  [**Download Online APK**](https://github.com/ashimcodes/AshForge/releases/download/v1.0.3/ash-forge-online-v1.0.3.apk) &nbsp;•&nbsp;
  [**Download Offline APK**](https://github.com/ashimcodes/AshForge/releases/download/v1.0.3/ash-forge-offline-v1.0.3.apk) &nbsp;•&nbsp;
...
<p align="center">
  <a href="https://youtu.be/QzAau52Z7yQ" target="_blank" rel="noopener noreferrer">
    <img src="https://img.youtube.com/vi/QzAau52Z7yQ/maxresdefault.jpg" alt="Ash Forge Walkthrough and Live Product Demo" width="920" />
  </a>
  <br />
...
> Ash Forge runs on **ARM64 Android devices** using a private userspace PRoot layer. While isolated from other apps via standard Android sandbox permissions, PRoot is not a virtualization boundary or hardened security jail. Only execute projects and dependencies you own or trust.
...
<div align="center">
  ...
  <p>Both editions contain the complete Ash Forge app and support secure in-app updates beginning with v1.0.3.</p>
</div>
...
<table>
  <tr>
    <td width="50%" valign="top" align="center">
      ...
      <a href="https://github.com/ashimcodes/AshForge/releases/download/v1.0.3/ash-forge-online-v1.0.3.apk">
    ...
    <td width="50%" valign="top" align="center">
      ...
      <a href="https://github.com/ashimcodes/AshForge/releases/download/v1.0.3/ash-forge-offline-v1.0.3.apk">
...
Ash Forge unites modern **Jetpack Compose UI** with a self-contained **Ubuntu 20.04 LTS subsystem**. It gives you a desktop-class software development environment in your pocket without requiring root access, unlocked bootloaders, or external applications like Termux.
...
### 1. Download & Install
Download the latest signed release APK from [GitHub Releases](https://github.com/ashimcodes/AshForge/releases/latest).
...
Ash Forge uses Claude Code's Anthropic-compatible API protocol. You can connect official endpoints or route requests through compatible translation proxies:
...
When Android is selected during onboarding, Ash Forge installs that complete toolchain into its private Ubuntu environment. Android projects can then be built with the workspace play button. The resulting debug APK is passed directly to Android's system package installer and launched after installation; USB debugging, wireless debugging, an ADB port, and a pairing code are not required. Android still requires the user to allow installs from Ash Forge and confirm each installation.

<br />

## Architecture

Ash Forge bridges native Android Jetpack Compose to an isolated PRoot Linux execution layer via an optimized C++ JNI bridge:
...
git clone https://github.com/ashimcodes/AshForge.git
cd Mobile-Harness
...
Ash Forge allows downloading optional developer packs on demand to conserve space:
...
* **Zero Cloud Intermediaries**: Ash Forge connects your device directly to your chosen AI endpoint. No intermediate relays or telemetry servers collect your prompts or code.
...
Ash Forge is currently intended for signed direct APK distribution and private testing. Its Android-project workflow requests permission to submit user-built APKs to Android's package installer, which requires a dedicated Google Play policy declaration and approval if distributed through Play.
...
* **OS Process Management**: Heavy compilation workloads may be throttled if Android applies aggressive battery optimization. It is recommended to exempt Ash Forge from battery optimization in device settings.

<br />

## Legal & Trademarks

* Ash Forge is an independent open-source project and is not affiliated with, endorsed by, or sponsored by Anthropic.
...
<div align="center">
  ...
  <br />
  <sub>Copyright © 2026 Ash. All rights reserved.</sub>
</div>
