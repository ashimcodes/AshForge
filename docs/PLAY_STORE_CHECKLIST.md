...
This checklist covers the Play-facing work for package `com.ashim.ashforge`. It does not resolve the separate policy and technical review required for the downloadable local Linux and Claude Code runtime.

## Implemented in the project

- [x] Stable application ID: `com.ashim.ashforge`
...
- [ ] Reserve and register `com.ashim.ashforge` in Play Console
...
Account-deletion and Play Billing requirements apply only if Ash Forge later introduces first-party accounts or sells digital subscriptions in the app.
...
./gradlew \
  ...
  -PprivacyPolicyUrl=https://github.com/ashimcodes/AshForge/blob/main/PRIVACY.md \
